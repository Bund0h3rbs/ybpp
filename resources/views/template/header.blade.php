<div class="main-header">
  ...
  <div class="logo-header" data-background-color="white">
    ...
    <a href="{{url('home')}}" class="logo ">
      ...
      <dt class="navbar-brand text-primary text-bold">ADMINISTRATOR</dt>
    </a>
              ...
              <li>
                <div class="user-box">
                  ...
                  <div class="u-text">
                    ...
                    <p class="text-muted">{{Auth::user()->email}}</p><a href="{{url('myprofile')}}" class="btn btn-xs btn-secondary btn-sm">View Profile</a>
                  </div>
                </div>
              </li>
              <li>
