...
<div class="modal-header pb-2">
  ...
  <div class="modal-body">
    <div class="text-center">
        <dt class="text-12">Surat Masuk</dt>
    ...
    <div class="col-md-12 mt-2">
        ...
        <div class="form-group">
            ...
            <div class="input-group">
            {{ Form::text('name',$data->name ?? null, array('class'=>'form-control border-br10', 'required','id'=>'name','placeholder'=>'Undangan'))}}
            </div>
        </div>
        <div class="form-group">
            <label>Pengirim</label>
            <div class="input-group">
            {{ Form::text('pengirim',$data->pengirim ?? null, array('class'=>'form-control border-br10', 'required','id'=>'name','placeholder'=>'PT.'))}}
            </div>
        </div>
        <div class="form-group">
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="input-group">
                    {{ Form::date('tgl_masuk',$data->tgl_masuk ?? null, array('class'=>'form-control border-br10', 'required','id'=>'name','placeholder'=>'Ketua'))}}
                    </div>
                </div>
            </div>
        </div>
