                ...
                <div class="card-header">
                    <div class="card-head-row">
                        <div class="card-title">
                            <dt>Daftar List</dt>
                            <div class="text-muted mt-0" style="font-size:0.9rem">Daftar Surat Masuk</div>
                        </div>
...
@php
    $recordsUrl = route('mail_in.getlist');
