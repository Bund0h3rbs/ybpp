                ...
                <div class="card-header">
                    <div class="card-head-row">
                        <div class="card-title">
                            <dt>Daftar List</dt>
                            <div class="text-muted mt-0" style="font-size:0.9rem">Daftar Pengguna</div>
                        </div>
...
@php
    $recordsUrl = route('aksesuser.getlist');
...
<script>
    ...
    function resetPassword(id){
        ...
        swal({
            title: "Informasi!",
            title: 'Yakin Password Akan Direset?',
            icon: 'warning',
            buttons:{
                confirm: {
                    text : 'Yes, Reset',
            ...
            if (Delete) {
                $.ajax({
                    type: "POST",
                    url: "{{route('aksesuser.resetpassword')}}",
                    data:{"id":id},
                    headers: {
                        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                    },
