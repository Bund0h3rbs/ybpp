...
<div class="modal-header pb-2">
  ...
  <div class="modal-body">
    <div class="text-center">
        <dt class="text-12">Form Kelas / Tingkatan</dt>
    ...
    <div class="col-md-12 mt-2">
        ...
        <div class="form-group">
            ...
            <div class="input-group">
            {{ Form::text('name',$data->name ?? null, array('class'=>'form-control border-br10', 'required','id'=>'name','placeholder'=>'Kelas 1'))}}
            </div>
        </div>
