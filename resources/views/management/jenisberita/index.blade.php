...
<div class="page-inner p-4">
    <div class="col-md-12">
        <div class="panel-header row">
            <h4 class="page-title">{{$title ?? 'YBPP'}}</h4>
                ...
                <div class="card-header">
                    <div class="card-head-row">
                        <div class="card-title">
                            <dt>Daftar List</dt>
                            <div class="text-muted mt-0" style="font-size:0.9rem">Daftar Jenis Berita</div>
                        </div>
...
@php
    $recordsUrl = route('jnsberita.getlist');
