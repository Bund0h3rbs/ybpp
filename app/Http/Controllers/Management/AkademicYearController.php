...
class AkademicYearController extends Controller
{
    protected $folder = "management.tahun_akademik";
    protected $tabel;

    public function __construct()
    {
        $this->middleware('auth');
        $this->tabel = new Academic_year();
    }
    ...
    public function create(Request $request)
    {
        ...
        $with['data']   = $checkmenu;
        $with['parent'] = $this->tabel->whereNull('parent')->pluck('name','id')->all();
